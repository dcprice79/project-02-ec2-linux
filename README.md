...
![Network Settings Public IP](04-network-settings-public-ip-enabled)
![Security Group SSH Rule](05-security-group-ssh-rule)
![Instance Launch Success](06-instance-launch-success.png)
![Instance Running](07-instance-running-public-ip)
![SSH Connect](08-key-file-found)
![SSH Key](09-key-permissions-set)
![SSH Connected](10-ssh-connected-linux-commands)
![SSH Stopped](11-ssh connection-stopped)
